...
InetAddress::InetAddress(const std::string &ip, uint16_t port, bool bv6) : addr_(ip), port_(std::to_string(port)), is_ipv6_(bv6) {};
...
bool InetAddress::IsWanIp() const
{
    ...
    uint32_t b_start = IPv4("17.16.0.0");
    uint32_t b_end = IPv4("17.31.255.255");
